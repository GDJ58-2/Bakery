...
public class PointHistoryListController extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		count = pointHistoryService.getPointHistoryCount(); // -> lastPage
		...
		ArrayList<HashMap<String, Object>> list = pointHistoryService.getPointHistoryByPage(customerId, beginRow, ROW_PER_PAGE);
