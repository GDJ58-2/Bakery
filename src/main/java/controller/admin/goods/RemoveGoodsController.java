	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		*/
		...
		if(row == 1){
	    	...
	    	out.println("<script>alert('상품을 삭제하였습니다.'); location.href='goodsList';</script>");
			...
			// View
			RequestDispatcher rd = request.getRequestDispatcher("/admin/goods/removeGoods?goodsCode="+goodsCode+"&msg="+msg);
