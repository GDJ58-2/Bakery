...
public class GoodsService {
	...
	// 상품 리스트
	public ArrayList<HashMap<String, Object>> getGoodsListByPage(String categoryKind, int categoryNo, String search, String sort, int beginRow, int rowPerPage) {
		...
		try {
			...
			goodsDao = new GoodsDao();
			list = goodsDao.selectGoodsListByPage(conn, categoryKind, categoryNo, search, sort, beginRow, rowPerPage);
			conn.commit();
		} catch(Exception e) {
			try {
				conn.rollback();
