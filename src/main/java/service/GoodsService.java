...
public class GoodsService {
	...
	// 상품 리스트
	public ArrayList<HashMap<String, Object>> getGoodsListByPage(String categoryKind, int categoryNo, String search, int beginRow, int rowPerPage) {
		...
		try {
			...
			goodsDao = new GoodsDao();
			list = goodsDao.selectGoodsListByPage(conn, categoryKind, categoryNo, search, beginRow, rowPerPage);
			conn.commit();
		} catch(Exception e) {
			try {
				conn.rollback();
