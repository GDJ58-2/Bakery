                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6">
						...
						<div class="shop__pagination">
							<a type="button" href="${pageContext.request.contextPath}/pointHistory/pointHistoryList?currentPage=1"><span class="arrow_carrot-left"></span></a>
							...
							<a type="button" href="${pageContext.request.contextPath}/pointHistory/pointHistoryList?currentPage=${lastPage}"><span class="arrow_carrot-right"></span></a>
						</div>                        
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6">
