                        ...
                        <table class="table table-bordered">
							...
							<c:forEach var="ca" items="${list}">
								<tr>
									...
									<td>
										<a class="btn" href="${pageContext.request.contextPath}/customerAddress/modifyCustomerAddress?addressCode=${ca.addressCode}">수정</a>
									</td>
								</tr>
							</c:forEach>
						</table>
						<a class="primary-btn" href="${pageContext.request.contextPath}/customerAddress/addCustomerAddress">추가</a>
                    </div>
                </div>          
            </div>     
        </div>
