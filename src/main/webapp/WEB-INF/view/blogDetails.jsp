...
<body>
    ...
    <!-- Blog Hero Begin -->
    <div class="blog-hero set-bg" data-setbg="${pageContext.request.contextPath}/resources/static/img/blog/details/blog-hero.jpg">
        <div class="container">
                    ...
                    <div class="blog__details__content">
                        ...
                        <div class="blog__details__recipe">
                            <div class="blog__details__recipe__item">
                                <h6><img src="${pageContext.request.contextPath}/resources/static/img/blog/details/user.png" alt=""> SERVES</h6>
                                <span>2 as a main, 4 as a side</span>
                            </div>
                            <div class="blog__details__recipe__item">
                                <h6><img src="${pageContext.request.contextPath}/resources/static/img/blog/details/clock.png" alt=""> PREP TIME</h6>
                                <span>15 minute</span>
                            </div>
                            <div class="blog__details__recipe__item">
                                <h6><img src="${pageContext.request.contextPath}/resources/static/img/blog/details/clock.png" alt=""> COOK TIME</h6>
                                <span>15 minute</span>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="blog__details__ingredients__pic">
                                        <img src="${pageContext.request.contextPath}/resources/static/img/blog/details/blog-details.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="blog__details__author">
                            <div class="blog__details__author__pic">
                                <img src="${pageContext.request.contextPath}/resources/static/img/blog/details/blog-author.jpg" alt="">
                            </div>
                        ...
                        <div class="blog__details__comment">
                            ...
                            <div class="blog__details__comment__item">
                                <div class="blog__details__comment__item__pic">
                                    <img src="${pageContext.request.contextPath}/resources/static/img/blog/details/comment-1.jpg" alt="">
                                </div>
                            ...
                            <div class="blog__details__comment__item blog__details__comment__item--reply">
                                <div class="blog__details__comment__item__pic">
                                    <img src="${pageContext.request.contextPath}/resources/static/img/blog/details/comment-2.jpg" alt="">
                                </div>
                                <div class="blog__details__comment__item__text">
                            ...
                            <div class="blog__details__comment__item">
                                <div class="blog__details__comment__item__pic">
                                    <img src="${pageContext.request.contextPath}/resources/static/img/blog/details/comment-3.jpg" alt="">
                                </div>
                                <div class="blog__details__comment__item__text">
                                    <h6>Michael Luna</h6>
                                    <span>26 Feb 2020</span>
